...
.eqv TILEMAP_TILE_W 100
.eqv TILEMAP_TILE_H 16
.eqv TILEMAP_TILE_SIZE 1600 #= TILEMAP_TILE_W * TILEMAP_TILE_H

# Width, height, and size of the tilemap in pixels.
.eqv TILEMAP_PIXEL_W 500 #= TILEMAP_TILE_W * 5
.eqv TILEMAP_PIXEL_H 80 #= TILEMAP_TILE_H * 5
.eqv TILEMAP_PIXEL_SIZE 40000 #= TILEMAP_PIXEL_W * TILEMAP_PIXEL_H
...
.eqv TILEMAP_SCX_MAX 436 #= TILEMAP_PIXEL_W - TILEMAP_VIEWPORT_W
.eqv TILEMAP_SCY_MIN 0
.eqv TILEMAP_SCY_MAX 24 #= TILEMAP_PIXEL_H - TILEMAP_VIEWPORT_H
